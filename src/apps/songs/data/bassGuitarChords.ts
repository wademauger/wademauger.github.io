// Bass Guitar chords (4 strings): -1 = muted, 0 = open, >0 = fret number
export const bassGuitarChords = {
  ...
  'Cadd9': { frets: [3, 2, 0, 3], fingers: [3, 2, 0, 4] },
  'C#add9': { frets: [4, 3, 1, 4], fingers: [3, 2, 1, 4] },
  'Dbadd9': { frets: [4, 3, 1, 4], fingers: [3, 2, 1, 4] },
  'Dadd9': { frets: [5, 4, 2, 5], fingers: [3, 2, 1, 4] },
  'D#add9': { frets: [6, 5, 3, 6], fingers: [3, 2, 1, 4] },
  'Ebadd9': { frets: [6, 5, 3, 6], fingers: [3, 2, 1, 4] },
  'Eadd9': { frets: [7, 6, 4, 7], fingers: [3, 2, 1, 4] },
  'Fadd9': { frets: [8, 7, 5, 8], fingers: [3, 2, 1, 4] },
  'F#add9': { frets: [9, 8, 6, 9], fingers: [3, 2, 1, 4] },
  'Gbadd9': { frets: [9, 8, 6, 9], fingers: [3, 2, 1, 4] },
  'Gadd9': { frets: [10, 9, 7, 10], fingers: [3, 2, 1, 4] },
  'G#add9': { frets: [11, 10, 8, 11], fingers: [3, 2, 1, 4] },
  'Abadd9': { frets: [11, 10, 8, 11], fingers: [3, 2, 1, 4] },
  'Aadd9': { frets: [0, 0, 2, 0], fingers: [0, 0, 1, 0] },
  'A#add9': { frets: [1, 1, 3, 1], fingers: [1, 1, 3, 1] },
  'Bbadd9': { frets: [1, 1, 3, 1], fingers: [1, 1, 3, 1] },
  'Badd9': { frets: [2, 2, 4, 2], fingers: [1, 1, 3, 1] },

  // Sus2 chords (suspended 2nd)
  'Csus2': { frets: [3, 0, 2, 3], fingers: [3, 0, 1, 4] },
  'C#sus2': { frets: [4, 1, 3, 4], fingers: [3, 1, 2, 4] },
  'Dbsus2': { frets: [4, 1, 3, 4], fingers: [3, 1, 2, 4] },
  'Dsus2': { frets: [5, 2, 4, 5], fingers: [3, 1, 2, 4] },
  'D#sus2': { frets: [6, 3, 5, 6], fingers: [3, 1, 2, 4] },
  'Ebsus2': { frets: [6, 3, 5, 6], fingers: [3, 1, 2, 4] },
  'Esus2': { frets: [7, 4, 6, 7], fingers: [3, 1, 2, 4] },
  'Fsus2': { frets: [8, 5, 7, 8], fingers: [3, 1, 2, 4] },
  'F#sus2': { frets: [9, 6, 8, 9], fingers: [3, 1, 2, 4] },
  'Gbsus2': { frets: [9, 6, 8, 9], fingers: [3, 1, 2, 4] },
  'Gsus2': { frets: [10, 7, 9, 10], fingers: [3, 1, 2, 4] },
  'G#sus2': { frets: [11, 8, 10, 11], fingers: [3, 1, 2, 4] },
  'Absus2': { frets: [11, 8, 10, 11], fingers: [3, 1, 2, 4] },
  'Asus2': { frets: [0, 0, 2, 0], fingers: [0, 0, 1, 0] },
  'A#sus2': { frets: [1, 1, 3, 1], fingers: [1, 1, 3, 1] },
  'Bbsus2': { frets: [1, 1, 3, 1], fingers: [1, 1, 3, 1] },
  'Bsus2': { frets: [2, 2, 4, 2], fingers: [1, 1, 3, 1] },

  // Sus4 chords (suspended 4th)
  'Csus4': { frets: [3, 1, 3, 6], fingers: [2, 1, 3, 4] },
  'C#sus4': { frets: [4, 2, 4, 7], fingers: [2, 1, 3, 4] },
  'Dbsus4': { frets: [4, 2, 4, 7], fingers: [2, 1, 3, 4] },
  'Dsus4': { frets: [5, 3, 5, 8], fingers: [2, 1, 3, 4] },
  'D#sus4': { frets: [6, 4, 6, 9], fingers: [2, 1, 3, 4] },
  'Ebsus4': { frets: [6, 4, 6, 9], fingers: [2, 1, 3, 4] },
  'Esus4': { frets: [7, 5, 7, 10], fingers: [2, 1, 3, 4] },
  'Fsus4': { frets: [8, 6, 8, 11], fingers: [2, 1, 3, 4] },
  'F#sus4': { frets: [9, 7, 9, 12], fingers: [2, 1, 3, 4] },
  'Gbsus4': { frets: [9, 7, 9, 12], fingers: [2, 1, 3, 4] },
  'Gsus4': { frets: [10, 8, 10, 13], fingers: [2, 1, 3, 4] },
  'G#sus4': { frets: [11, 9, 11, 14], fingers: [2, 1, 3, 4] },
  'Absus4': { frets: [11, 9, 11, 14], fingers: [2, 1, 3, 4] },
  'Asus4': { frets: [0, 0, 3, 0], fingers: [0, 0, 1, 0] },
  'A#sus4': { frets: [1, 1, 4, 1], fingers: [1, 1, 3, 1] },
  'Bbsus4': { frets: [1, 1, 4, 1], fingers: [1, 1, 3, 1] },
  'Bsus4': { frets: [2, 2, 5, 2], fingers: [1, 1, 3, 1] },

  // 9th chords (dominant 7th + 9th)
  'C9': { frets: [3, 1, 3, 1], fingers: [3, 1, 4, 2] },
  'C#9': { frets: [4, 2, 4, 2], fingers: [3, 1, 4, 2] },
  'Db9': { frets: [4, 2, 4, 2], fingers: [3, 1, 4, 2] },
  'D9': { frets: [5, 3, 5, 3], fingers: [3, 1, 4, 2] },
  'D#9': { frets: [6, 4, 6, 4], fingers: [3, 1, 4, 2] },
  'Eb9': { frets: [6, 4, 6, 4], fingers: [3, 1, 4, 2] },
  'E9': { frets: [7, 5, 7, 5], fingers: [3, 1, 4, 2] },
  'F9': { frets: [8, 6, 8, 6], fingers: [3, 1, 4, 2] },
  'F#9': { frets: [9, 7, 9, 7], fingers: [3, 1, 4, 2] },
  'Gb9': { frets: [9, 7, 9, 7], fingers: [3, 1, 4, 2] },
  'G9': { frets: [10, 8, 10, 8], fingers: [3, 1, 4, 2] },
  'G#9': { frets: [11, 9, 11, 9], fingers: [3, 1, 4, 2] },
  'Ab9': { frets: [11, 9, 11, 9], fingers: [3, 1, 4, 2] },
  'A9': { frets: [0, 0, 2, 0], fingers: [0, 0, 1, 0] },
  'A#9': { frets: [1, 1, 3, 1], fingers: [1, 1, 3, 1] },
  'Bb9': { frets: [1, 1, 3, 1], fingers: [1, 1, 3, 1] },
  'B9': { frets: [2, 2, 4, 2], fingers: [1, 1, 3, 1] },
  ...
  'Caug': { frets: [3, 2, 1, 4], fingers: [3, 2, 1, 4] },
  'C#aug': { frets: [4, 3, 2, 5], fingers: [3, 2, 1, 4] },
  'Dbaug': { frets: [4, 3, 2, 5], fingers: [3, 2, 1, 4] },
  'Daug': { frets: [5, 4, 3, 6], fingers: [3, 2, 1, 4] },
  'D#aug': { frets: [6, 5, 4, 7], fingers: [3, 2, 1, 4] },
  'Ebaug': { frets: [6, 5, 4, 7], fingers: [3, 2, 1, 4] },
  'Eaug': { frets: [0, 1, 0, 4], fingers: [0, 1, 0, 4] },
  'Faug': { frets: [1, 2, 1, 5], fingers: [1, 2, 1, 4] },
  'F#aug': { frets: [2, 3, 2, 6], fingers: [1, 2, 1, 4] },
  'Gbaug': { frets: [2, 3, 2, 6], fingers: [1, 2, 1, 4] },
  'Gaug': { frets: [3, 4, 3, 7], fingers: [1, 2, 1, 4] },
  'G#aug': { frets: [4, 5, 4, 8], fingers: [1, 2, 1, 4] },
  'Abaug': { frets: [4, 5, 4, 8], fingers: [1, 2, 1, 4] },
  'Aaug': { frets: [0, 1, 0, 4], fingers: [0, 1, 0, 4] },
  'A#aug': { frets: [1, 2, 1, 5], fingers: [1, 2, 1, 4] },
  'Bbaug': { frets: [1, 2, 1, 5], fingers: [1, 2, 1, 4] },
  'Baug': { frets: [2, 3, 2, 6], fingers: [1, 2, 1, 4] },

  // Major 9th chords (major 7th + 9th)
  'Cmaj9': { frets: [3, 2, 4, 3], fingers: [2, 1, 4, 3] },
  'C#maj9': { frets: [4, 3, 5, 4], fingers: [2, 1, 4, 3] },
  'Dbmaj9': { frets: [4, 3, 5, 4], fingers: [2, 1, 4, 3] },
  'Dmaj9': { frets: [5, 4, 6, 5], fingers: [2, 1, 4, 3] },
  'D#maj9': { frets: [6, 5, 7, 6], fingers: [2, 1, 4, 3] },
  'Ebmaj9': { frets: [6, 5, 7, 6], fingers: [2, 1, 4, 3] },
  'Emaj9': { frets: [0, 2, 1, 2], fingers: [0, 3, 1, 4] },
  'Fmaj9': { frets: [1, 3, 2, 3], fingers: [1, 4, 2, 3] },
  'F#maj9': { frets: [2, 4, 3, 4], fingers: [1, 4, 2, 3] },
  'Gbmaj9': { frets: [2, 4, 3, 4], fingers: [1, 4, 2, 3] },
  'Gmaj9': { frets: [3, 5, 4, 5], fingers: [1, 4, 2, 3] },
  'G#maj9': { frets: [4, 6, 5, 6], fingers: [1, 4, 2, 3] },
  'Abmaj9': { frets: [4, 6, 5, 6], fingers: [1, 4, 2, 3] },
  'Amaj9': { frets: [0, 2, 1, 2], fingers: [0, 3, 1, 4] },
  'A#maj9': { frets: [1, 3, 2, 3], fingers: [1, 4, 2, 3] },
  'Bbmaj9': { frets: [1, 3, 2, 3], fingers: [1, 4, 2, 3] },
  'Bmaj9': { frets: [2, 4, 3, 4], fingers: [1, 4, 2, 3] },
  ...
  'Am9': { frets: [0, 2, 1, 2], fingers: [0, 3, 1, 4] },
  'A#m9': { frets: [1, 3, 2, 3], fingers: [1, 4, 2, 3] },
  'Bbm9': { frets: [1, 3, 2, 3], fingers: [1, 4, 2, 3] },
  'Bm9': { frets: [2, 4, 3, 4], fingers: [1, 4, 2, 3] },

  // Altered dominants - 7b5 chords
  'C7b5': { frets: [3, 4, 2, 4], fingers: [2, 4, 1, 3] },
  'C#7b5': { frets: [4, 5, 3, 5], fingers: [2, 4, 1, 3] },
  'Db7b5': { frets: [4, 5, 3, 5], fingers: [2, 4, 1, 3] },
  'D7b5': { frets: [5, 6, 4, 6], fingers: [2, 4, 1, 3] },
  'D#7b5': { frets: [6, 7, 5, 7], fingers: [2, 4, 1, 3] },
  'Eb7b5': { frets: [6, 7, 5, 7], fingers: [2, 4, 1, 3] },
  'E7b5': { frets: [0, 2, 0, 3], fingers: [0, 2, 0, 4] },
  'F7b5': { frets: [1, 3, 1, 4], fingers: [1, 3, 2, 4] },
  'F#7b5': { frets: [2, 4, 2, 5], fingers: [1, 3, 2, 4] },
  'Gb7b5': { frets: [2, 4, 2, 5], fingers: [1, 3, 2, 4] },
  'G7b5': { frets: [3, 5, 3, 6], fingers: [1, 3, 2, 4] },
  'G#7b5': { frets: [4, 6, 4, 7], fingers: [1, 3, 2, 4] },
  'Ab7b5': { frets: [4, 6, 4, 7], fingers: [1, 3, 2, 4] },
  'A7b5': { frets: [0, 1, 0, 3], fingers: [0, 1, 0, 4] },
  'A#7b5': { frets: [1, 2, 1, 4], fingers: [1, 2, 1, 4] },
  'Bb7b5': { frets: [1, 2, 1, 4], fingers: [1, 2, 1, 4] },
  'B7b5': { frets: [2, 3, 2, 5], fingers: [1, 2, 1, 4] },
  ...
  'E7#5': { frets: [0, 1, 0, 4], fingers: [0, 1, 0, 4] },
  'F7#5': { frets: [1, 2, 1, 5], fingers: [1, 2, 1, 4] },
  'F#7#5': { frets: [2, 3, 2, 6], fingers: [1, 2, 1, 4] },
  'Gb7#5': { frets: [2, 3, 2, 6], fingers: [1, 2, 1, 4] },
  'G7#5': { frets: [3, 4, 3, 7], fingers: [1, 2, 1, 4] },
  'G#7#5': { frets: [4, 5, 4, 8], fingers: [1, 2, 1, 4] },
  'Ab7#5': { frets: [4, 5, 4, 8], fingers: [1, 2, 1, 4] },
  'A7#5': { frets: [0, 1, 0, 4], fingers: [0, 1, 0, 4] },
  'A#7#5': { frets: [1, 2, 1, 5], fingers: [1, 2, 1, 4] },
  'Bb7#5': { frets: [1, 2, 1, 5], fingers: [1, 2, 1, 4] },
  'B7#5': { frets: [2, 3, 2, 6], fingers: [1, 2, 1, 4] }
};
